                ...
                <div className="w-60">
                    <div>
                        ...
                        <input
                            ...
                            type="text"
                            className="bg-dark-100 text-gray-900 text-sm rounded-3xl w-full px-4 py-2"
                            placeholder="Search"
                        />
                    </div>
                    {focused && (
                        ...
                        <div className='p-2 mt-6 mr-2 h-90'>
                            ...
                            <div className="mt-4 cursor-pointer flex items-center justify-center mr-4">
                                ...
                                >
                                    ...
                                    <div
                                        id = 'imgProfil'
                                className="mt-7 rounded-full border-rose-600 cursor-pointer flex items-center justify-center w-8 h-8 relative select-none "
                                ...
                                <div className={ !dropdownOpen ? "hidden" : "" + " bg-white text-base z-50 list-none divide-y divide-gray-100 rounded shadow absolute top-10 right-0"} >
                                    <ul className="py-1" aria-labelledby="dropdown">
                                        ...
                                        <li
                                            onClick={() => firebase.auth().signOut()}
                                        >
                                            <span className="text-sm hover:bg-gray-100 text-gray-700 block px-4 py-2">Logout</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
