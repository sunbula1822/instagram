...
const notify = () => toast("Wow so easy!");
    ...
    return (
      <div className=" h-12 border-t border-gray-primary mb-5 pt-4 pb-4">
        <form
        ...
        >
          ...
          <input
            ...
            autoComplete="off"
            className="h-11 text-sm w-full mr-3 py-5 px-2  input-style"
            type="text"
            name="AddComment"
          ...
          <button
            type="submit"
            className="mt-2 border-2 w-20 btn text-lg font-bold text-blue-500"
            onClick={notify}
          >
            Post
          </button>
